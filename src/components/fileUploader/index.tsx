...
import { FileUploaderRegular, OutputCollectionState, OutputCollectionStatus, OutputFileEntry } from "@uploadcare/react-uploader";
import "./index.css";
            ...
            <div className="grid  grid-cols-2 gap-4 mt-8">
                {fileEntry.files.map(file => (
                    <div className="relative" key={file.uuid}>
                        <img src={`${file.cdnUrl}/-/format/auto/-/quality/smart/-/stretch/fill/-/progressive/yes/` as string} alt={file.uuid as string} />
